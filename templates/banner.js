(function() {
    ...
    var i = 0;
      ...
      bannerFooter.style = "display: block; background-color: {{ banner_color }}; color: #000000; font-weight: bold; text-align: center; text-shadow: 1px 1px 0 #444; position: fixed; width: 100%; bottom: 0; z-index: 99999; height: 16px"
      var body = document.body;
