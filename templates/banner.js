(function() {
    ...
    var i = 0;
      ...
      banner.style = "display: block; background-color: {{ banner_color }}; color: #fff; font-weight: bold; text-align: center; text-shadow: 1px 1px 0 #444; position: absolute; width: 100%; height: 16px; foreground-color: #000000"
